...
CREATE TABLE `user_payments` (
  ...
  CONSTRAINT `user_payments_ibfk_2` FOREIGN KEY (`Payment_ID`) REFERENCES `payments` (`Payment_ID`)
...
INSERT INTO `user_payments` VALUES (7,6,8,300.00,'2024-11-17'),(8,6,9,200.00,'2024-11-17'),(9,6,10,300.00,'2024-11-17'),(10,6,11,400.00,'2024-11-20'),(11,24,12,400.00,'2024-11-20'),(12,6,13,200.00,'2024-11-21'),(13,6,14,100.00,'2024-11-21');
