...
CREATE TABLE `user_claims` (
  ...
  CONSTRAINT `user_claims_ibfk_1` FOREIGN KEY (`User_ID`) REFERENCES `users` (`User_ID`),
  CONSTRAINT `user_claims_ibfk_2` FOREIGN KEY (`Claim_ID`) REFERENCES `claims` (`Claim_ID`)
